...
> **当前开发版本 [`v1.4.0 LTS`](https://github.com/Zafer-Liu/Data-Analysis-Agent/releases/latest)** · 2026 年 8 月 21 日 · 发布安装包以前请以源码版本与更新日志为准。

v1.4.0 参加飞书 AI 绝活黑客松，接入飞书机器人，内置多维表格分析功能，同时优化部分功能。
